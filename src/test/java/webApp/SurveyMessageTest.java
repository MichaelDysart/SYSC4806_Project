...
public class SurveyMessageTest {
    ...
    @Before
    public void setup() {
        q1 = new ArrayList<>(Arrays.asList(new QuestionMessage("Number", "First 3 numbers?", 1, 3, "1,2,3", 123, sal1, nal1)));
        q2 = new ArrayList<>(Arrays.asList(new QuestionMessage("String", "How to say bye?", 0, 0, "Bye, See ya, Ciao", 0, sal2, nal2)));
